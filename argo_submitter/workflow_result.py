...
from argo_submitter.artifact import Artifact
from argo_submitter.workflow_status_checker import WorkflowStatusChecker
...
class WorkflowResult:
    ...
    def __init__(self, workflow_name: str, workflow_status: WorkflowStatus,
    ...
    def wait_for_completion(self, timeout=None):
        ...
        self.status = self.workflow_status_checker.current_phase
        return self.status
    ...
    def outputs(self) -> dict[str, Union[str, Artifact]]:
        if self.status is None or self.status == WorkflowStatus.Running:
            ...
            return self._get_outputs(list(self.workflow_status_checker
                                          .workflow_current_status_data_dict['status']['nodes']
                                          .values())[0]['outputs'])