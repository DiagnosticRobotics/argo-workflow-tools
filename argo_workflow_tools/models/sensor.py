...
class LogEntry(BaseModel):
    dependency_name: Optional[str] = Field(
        None, alias="dependencyName", title="optional - trigger dependency name"
    )
    event_context: Optional[str] = Field(
        None, alias="eventContext", title="optional - Cloud Event context"
    )
    ...
    trigger_name: Optional[str] = Field(
        None, alias="triggerName", title="optional - any trigger name"
    )
