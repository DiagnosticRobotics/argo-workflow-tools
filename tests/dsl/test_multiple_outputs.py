...
from argo_workflow_tools.dsl.parameter_builders.multiple_output_parameter_builder import (
...
@dsl.Task(
    image="python:3.7",
    outputs={
        "message": MultipleOutputParameterBuilder(str),
        "bye_message": MultipleOutputParameterBuilder(str),
    },
)
